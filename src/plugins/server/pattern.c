...
void begin_pcre2() {
	...
	ctr_internal_create_func(CtrServerPCRE2, CTR_STRINGOBJ( CTR_DICT_NEW_SET ), &ctr_server_pcre2_new_set );
	ctr_internal_create_func(CtrServerPCRE2, CTR_STRINGOBJ( CTR_DICT_MATCH_DO_SET ), &ctr_server_pcre2_match_do );
	// alias for match/do but intended for capturing matches only
	ctr_internal_create_func(CtrServerPCRE2, CTR_STRINGOBJ( CTR_DICT_MATCH_CAPTURE_SET ), &ctr_server_pcre2_match_do );
	ctr_internal_create_func(CtrServerPCRE2, CTR_STRINGOBJ( CTR_DICT_MATCH_SET ), &ctr_server_pcre2_match_count );
	ctr_internal_object_add_property(CtrStdWorld, CTR_STRINGOBJ( CTR_DICT_PATTERN_OBJECT ), CtrServerPCRE2, CTR_CATEGORY_PUBLIC_PROPERTY);
}