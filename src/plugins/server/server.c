...
void begin() {
	...
	ctr_internal_create_func(serverObject, ctr_build_string_from_cstring( CTR_DICT_HTML_ENCODE_SET ), &ctr_server_htmlencode_set );
	ctr_internal_create_func(serverObject, ctr_build_string_from_cstring( CTR_DICT_URL_ENCODE_SET ), &ctr_server_urlencode_set );
	ctr_internal_create_func(serverObject, ctr_build_string_from_cstring( CTR_DICT_FORM_ENCODE_SET ), &ctr_server_formencode_set );
	ctr_internal_create_func(serverObject, ctr_build_string_from_cstring( CTR_DICT_BASE64_ENCODE_SET ), &ctr_server_base64encode_set );
	ctr_internal_create_func(serverObject, ctr_build_string_from_cstring( CTR_DICT_BASE64_DECODE_SET ), &ctr_server_base64decode_set );
	ctr_internal_create_func(serverObject, ctr_build_string_from_cstring( CTR_DICT_LINK_SET ), &ctr_server_link_set );
	...
	ctr_internal_create_func(formatObject, ctr_build_string_from_cstring( CTR_DICT_FORMAT_SET ), &ctr_format_format_set );
	ctr_internal_create_func(formatObject, ctr_build_string_from_cstring( CTR_DICT_APPLY_TO ), &ctr_format_apply_to );
	ctr_internal_create_func(formatObject, ctr_build_string_from_cstring( CTR_DICT_APPLY_TO_INT_SET ), &ctr_format_apply_int_to );
	ctr_internal_object_add_property(CtrStdWorld, ctr_build_string_from_cstring( CTR_DICT_FORMAT_OBJECT ), formatObject, CTR_CATEGORY_PUBLIC_PROPERTY);
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_IPV4 ), &ctr_string_ipv4 );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_IPV6 ), &ctr_string_ipv6 );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_MAC ), &ctr_string_mac );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_HTML ), &ctr_string_tohtml );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_HTML_ENCODE ), &ctr_string_htmlencode );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_URL_ENCODE ), &ctr_string_urlencode );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_FORM_ENCODE ), &ctr_string_formencode );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_BASE64_ENCODE ), &ctr_string_b64encode );
	ctr_internal_create_func(CtrStdString, ctr_build_string_from_cstring( CTR_DICT_BASE64_DECODE ), &ctr_string_b64decode );
	#ifdef LIBCURL
	begin_net();
	#endif
	begin_http();
