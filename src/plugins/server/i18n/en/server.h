...
#define CTR_DICT_REQUEST_OBJECT                  "HTTP-Request"              // Word for object representing the current HTTP-Request
...
#define CTR_DICT_XOR_AND_SET                     "xor:and:"                  // Word to decribe XOR'ing blob1 with blob2
