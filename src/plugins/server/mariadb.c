...
void begin_mariadb(){
	...
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_NEW ), &ctr_mariadb_new );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_URL_HOST_SET ), &ctr_mariadb_host_set );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_URL_USERNAME_SET ), &ctr_mariadb_username_set );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_PASSWORD_SET ), &ctr_mariadb_password_set );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_DATABASENAME_SET ), &ctr_mariadb_dbname_set );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_CONNECT ), &ctr_mariadb_connect );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_DATABASE_QUERY_SET ), &ctr_mariadb_query_set );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_CONNECTED ), &ctr_mariadb_connected );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_COMMIT ), &ctr_mariadb_commit );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_ROLLBACK ), &ctr_mariadb_rollback );
	ctr_internal_create_func(CtrMariaDB, CTR_STRINGOBJ( CTR_DICT_CLOSE ), &ctr_mariadb_close );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_NEW ), &ctr_mariadb_query_new );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_NEW_SET ), &ctr_mariadb_query_new_set );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_DATABASE_SET ), &ctr_mariadb_query_database_set );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_DATABASE_QUERY_SET ), &ctr_mariadb_query_query_set );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_STRING ), &ctr_mariadb_query_tostring );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_DATABASE_QUERYPARAMS_SET ), &ctr_mariadb_query_param_set );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_EXECUTE ), &ctr_mariadb_query_execute );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_FETCH_SET ), &ctr_mariadb_query_fetch );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_DATABASE_INSERTID ), &ctr_mariadb_query_insert_id );
	ctr_internal_create_func(CtrMariaDBQuery, CTR_STRINGOBJ( CTR_DICT_CLOSE ), &ctr_mariadb_query_close );
	ctr_internal_object_add_property(CtrStdWorld, CTR_STRINGOBJ( CTR_DICT_DATABASE_MARIADB_OBJECT ), CtrMariaDB, CTR_CATEGORY_PUBLIC_PROPERTY);
	ctr_internal_object_add_property(CtrStdWorld, CTR_STRINGOBJ( CTR_DICT_DATABASE_MARIADB_QUERY_OBJECT ), CtrMariaDBQuery, CTR_CATEGORY_PUBLIC_PROPERTY);
