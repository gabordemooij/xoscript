...
void begin_http(){
	...
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_GET_SET ), &ctr_request_get_string );
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_GET_LIST_SET ), &ctr_request_get_array );
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_COOKIE_SET ), &ctr_request_cookie_string );
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_COOKIE_LIST_SET ), &ctr_request_cookie_array );
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_POST_SET ), &ctr_request_post_string );
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_UPLOAD_SET ), &ctr_request_file );
	ctr_internal_create_func(requestObject, CTR_STRINGOBJ( CTR_DICT_HTTP_REQUEST_POST_LIST_SET ), &ctr_request_post_array );
	ctr_internal_object_add_property(CtrStdWorld, CTR_STRINGOBJ( CTR_DICT_REQUEST_OBJECT ), requestObject, 0);
	urlObject = ctr_url_new(CtrStdObject, NULL);
	urlObject->link = CtrStdObject;
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_NEW ), &ctr_url_new );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_FROM_SET ), &ctr_url_from_set );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_URL_SCHEME ), &ctr_url_scheme );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_URL_HOST ), &ctr_url_host );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_URL_PORT ), &ctr_url_port );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_PATH ), &ctr_url_path );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_URL_QUERY ), &ctr_url_query );
	ctr_internal_create_func(urlObject, CTR_STRINGOBJ( CTR_DICT_URL_FRAGMENT ), &ctr_url_fragment );
	ctr_internal_object_add_property(CtrStdWorld, CTR_STRINGOBJ( CTR_DICT_URL_OBJECT ), urlObject, 0);
}
